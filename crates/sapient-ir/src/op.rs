...
pub enum OpType {
    ...
    Gemm { alpha: ordered_float::OrderedFloat<f64>, beta: ordered_float::OrderedFloat<f64>, trans_a: bool, trans_b: bool },
    ...
    LeakyRelu { alpha: ordered_float::OrderedFloat<f64> },
    Silu,
    HardSwish,
    ...
    Softmax { axis: i64 },
    LogSoftmax { axis: i64 },
    LayerNorm { axis: i64, epsilon: ordered_float::OrderedFloat<f64> },
    BatchNorm { epsilon: ordered_float::OrderedFloat<f64>, momentum: ordered_float::OrderedFloat<f64> },
    RmsNorm { epsilon: ordered_float::OrderedFloat<f64> },
    ...
    MaxPool { kernel_shape: [usize; 2], pads: [usize; 4], strides: [usize; 2] },
    AvgPool { kernel_shape: [usize; 2], pads: [usize; 4], strides: [usize; 2] },
    GlobalAvgPool,
    ...
    // ── Reduce ops ────────────────────────────────────────────────────────────
    ReduceSum  { axes: Vec<i64>, keep_dims: bool },
    ReduceMean { axes: Vec<i64>, keep_dims: bool },
    ReduceMax  { axes: Vec<i64>, keep_dims: bool },
    ReduceMin  { axes: Vec<i64>, keep_dims: bool },
    ArgMax { axis: i64, keep_dims: bool },
    ArgMin { axis: i64, keep_dims: bool },
    ...
    Dropout { ratio: ordered_float::OrderedFloat<f64> },
    Erf,
    Floor,
    Ceil,
    Round,
